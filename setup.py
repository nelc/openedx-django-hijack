#!/usr/bin/env python
"""
Package metadata for openedx_django_hijack.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_django_hijack', '__init__.py')
...
setup(
    name='openedx-django-hijack',
    version=VERSION,
    description="""Plugin to install use django-hijack in an Openedx Django installation""",
    long_description=README + '\n\n' + CHANGELOG,
    author='nelc',
    author_email='nelc-openedx@elc.edu.sa',
    url='https://github.com/nelc/openedx-django-hijack',
    packages=find_packages(
        include=['openedx_django_hijack', 'openedx_django_hijack.*'],
        exclude=["*tests"],
    ),
