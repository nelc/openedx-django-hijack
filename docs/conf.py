...
"""
openedx-django-hijack documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-django-hijack',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/nelc/openedx-django-hijack",
...
#
# html_title = 'openedx-django-hijack v0.0.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Plugin to install use django-hijack in an Openedx Django installation',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_django_hijack'),
                os.path.join(root_path, 'openedx_django_hijack/migrations')])
