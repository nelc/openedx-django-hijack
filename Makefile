...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd openedx_django_hijack && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd openedx_django_hijack && i18n_tool generate

detect_changed_source_translations:
	cd openedx_django_hijack && i18n_tool changed
...
pull_translations:
	find openedx_django_hijack/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/openedx-django-hijack/openedx_django_hijack/conf/locale:openedx_django_hijack/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd openedx_django_hijack && i18n_tool dummy
